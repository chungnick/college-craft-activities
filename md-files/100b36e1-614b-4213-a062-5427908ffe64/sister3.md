...
## FinDS Beginner's Program

The FinDS Level 1 Track (Beginner’s Program) is a college preparatory course on developing the mathematical foundation to take on a career in Computer Science and Data Science.

Learn more about this track by **visiting**[**mathfinds.ucsd.edu**](http://mathfinds.ucsd.edu)**for more details.**
...
* UT Austin (In-Person) and Online
* [Application Link](https://forms.gle/UMZfMcsFYyTrxvks6)

[Apply Here](https://forms.gle/UMZfMcsFYyTrxvks6)

### Information

Prerequisites

We do not expect a prior background in data science. A strong background in algebra and a willingness to work hard is all that is required to participate in the program. The program is appropriate for any student who has taken Algebra 2. Even college students seeking a solid background in the foundation of data science are welcome to apply.

Syllabus

The syllabus includes graph theory, combinatorics, probability, linear algebra, and calculus.

Intended Outcome

* **Bridge the gap** in math education for a successful future career
* Give opportunities to high school students in **research** early on
* Provide a unique opportunity to interact with faculty who are **dedicated to outreach and diversity efforts**
